...
public class TestRewardControllerIntegrationTesting {
    ...
    /**
     * Test to verify that getAllRewards() returns a non-empty list.
     * Ensures that rewards data is present.
     */
    ...
    /**
     * Test to fetch rewards for a specific customer ID.
     * Validate that the response contains the correct customer information and reward points.
     */
    @Test
    ...
    /**
     * Test to add a new transaction for a customer.
     * Verifies that the transaction is accepted and a success message is returned.
     */
